...
export class ProfileService {
  ...
  Expertise in Angular 2+ All versions, Angular, Javascript,  Node JS and UI with Responsive Designs .
  Have good understanding of Python, Jquery, MYSQL,R Programming and Machine Learning`

  about = "I am passionate about innovation and dedicated to generating new knowledge. I approach challenges with a positive attitude, tackling problems promptly and efficiently. I am highly mindful of the time I invest in my work, ensuring that every effort contributes to productive outcomes."
  resumeurl = "https://drive.google.com/file/d/1ejaLSsBoEMND1OeeAJXPMEAQ5qLIs8ic/view?usp=sharing"
  ...
  educationData: any = [
    {
      ...
      'info': `Nandha Engineering College, approved by AICTE, New Delhi, is affiliated with Anna University, Chennai.
Completed B.E in Electronic Communication Engineering with 7.8 CGPA.
Won the Best Student Award 3 times for excellent Academic records at College.
Maintained above 7.5 spi in every semester of college academic .`,
      'institution': 'Nandha Engineering College, TAMIL NADU'
    },
    {
      'id': '2',
      'from_to_year': '2013 - 2015',
      'education': 'Higher Secondary',
      'stream': 'Mathematics and Computer Science  ',
      'institution': 'SRI AMMAN MATRICULATION, TAMIL NADU',
      'info': `The High School was mainly focus on the bases of computer science, mathematics, and Chemistry
...
Completed my high school with 75%.`
    },
    {
      ...
      'institution': 'SRI AMMAN MATRICULATION, TAMIL NADU',
      'info': `The Secondary aims at Maths , English , Science, Social Science and Languages.
Completed my Secondary school with 81%.`
    }
  ];
  exprienceData: any = [
    {
      id: 4,
      company: 'Consecure Technologies',
      location: 'Bengaluru',
      timeline: 'Sept 2022 to Present',
      role: 'Software Developer',
      work: 'Working as a UI developer .Responsible for handling the UI in Angular and Managing the api calls in python and Rust.'
    ...
    },
    {
      ...
      timeline: 'Jan 2020 to April 2022',
      role: 'Excutive Trainee',
